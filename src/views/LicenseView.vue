<template>
  <div class="content">
    <h1>EUROPEAN UNION PUBLIC LICENCE v. 1.2</h1>
    <h2>EUPL © the European Union 2007, 2016</h2>
    <br /><br />
    <p>
    ...
    <br />
    <p class="italic">Licensed under the EUPL</p>
    <br />
    <p>
    ...
    <section>
      ...
      <br />
      <ul class="dashed">
        <li>‘The Licence’: this Licence.</li>
        <li>
        ...
        <li>‘The Work’: the Original Work or its Derivative Works.</li>
        <li>
    ...
    <section>
      <h2>2. Scope of the rights granted by the Licence</h2>
      <br />
      <p>
      ...
      <ul class="dashed">
        <li>use the Work in any circumstance and for all usage,</li>
        <li>reproduce the Work,</li>
        <li>modify the Work, and make Derivative Works based upon the Work,</li>
        <li>
        ...
        <li>distribute the Work or copies thereof,</li>
        <li>lend and rent the Work or copies thereof,</li>
        <li>sublicense rights in the Work or copies thereof.</li>
      </ul>
      <br />
      <p>
    ...
    <section>
      <h2>3. Communication of the Source Code</h2>
      <br />
      <p>
    ...
    <section>
      <h2>4. Limitations on copyright</h2>
      <br />
      <p>
    ...
    <section>
      <h2>5. Obligations of the Licensee</h2>
      <br />
      <p>
      ...
      <br />
      <p>
        <b>Attribution right</b>: The Licensee shall keep intact all copyright,
      ...
      <br />
      <p>
        <b>Copyleft clause:</b> If the Licensee distributes or communicates
        copies of the Original Works or Derivative Works, this Distribution or
      ...
      <br />
      <p>
        <b>Compatibility clause:</b> If the Licensee Distributes or Communicates
      ...
      <br />
      <p>
        <b>Provision of Source Code:</b> When distributing or communicating
        copies of the Work, the Licensee will provide a machine-readable copy of
        the Source Code or indicate a repository where this Source will be
        easily and freely available for as long as the Licensee continues to
        distribute or communicate the Work.
      </p>
      <br />
      <p>
        <b>Legal Protection:</b> This Licence does not grant permission to use
    ...
    <section>
      <h2>10. Acceptance of the Licence</h2>
      <br />
      <p>
    ...
    <section>
      <h2>11. Information to the public</h2>
      <br />
      <p>
    ...
    <section>
      <h2>12. Termination of the Licence</h2>
      <br />
      <p>
    ...
    <section>
      ...
      <br />
      <p>Without prejudice to specific agreement between parties,</p>
      <ul class="dashed">
        <li>
